...
type FakeFlinkApplications struct {
	Fake *FakeFlinkoperatorV1alpha1
	ns   string
}

var flinkapplicationsResource = schema.GroupVersionResource{Group: "flinkoperator.k8s.io", Version: "v1alpha1", Resource: "flinkapplications"}

var flinkapplicationsKind = schema.GroupVersionKind{Group: "flinkoperator.k8s.io", Version: "v1alpha1", Kind: "FlinkApplication"}
